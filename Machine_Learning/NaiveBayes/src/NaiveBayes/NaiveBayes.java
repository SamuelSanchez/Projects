...
public class NaiveBayes {
	...
	private static NaiveBayes naiveBayes_six_features = new NaiveBayes(6);
	...
	private NaiveBayes(int numberOfFeatures){
	...
	public void readTrainingData(String trainingData) throws Exception{
		...
		while(trainingDataLine != null){
			...
			if(features.length != numberOfFeatures+1)
				throw new Exception("Error : number of features [ " + features + " ] does not match [ " + numberOfFeatures+1 + " ]");
