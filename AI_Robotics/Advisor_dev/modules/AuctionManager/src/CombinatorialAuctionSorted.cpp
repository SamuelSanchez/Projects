#include "CombinatorialAuctionSorted.h"

     CombinatorialAuctionSorted::CombinatorialAuctionSorted():AUCTION_DURATION(10), //Give a value 
        firstAuction(true), inAuction(false), assigningTargets(false), numberOfRobots(0),
        AUCTION_TIME( 10 ) //Give it a value
     {}

    inline void CombinatorialAuctionSorted::Update()
    {
         updateAuction();
    ...
    inline void CombinatorialAuctionSorted::updateAuction()
    {
       if( !targetsToAuction->isCompleted() ){
    ...
    void CombinatorialAuctionSorted::startAuction()
    {
    ...
    void CombinatorialAuctionSorted::print()
    {
